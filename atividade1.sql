...
INSERT INTO tb_classe(nivel, classe, habilidade, arma) VALUES (149, "Arqueiro", "Precisão", "Arco e Flecha");
INSERT INTO tb_classe(nivel, classe, habilidade, arma) VALUES (50, "Bardo", "Lábia", "Alaude");

INSERT INTO tb_personagem(nome, raca, vida, defesa, ataque, classe_id) VALUES ("Cleison", "Anão", 1500, 3000, 1200, 1);
...
INSERT INTO tb_personagem(nome, raca, vida, defesa, ataque, classe_id) VALUES ("Cleide", "Humano", 500, 6000, 2000, 3);
...
SELECT * FROM tb_classe INNER JOIN tb_personagem ON tb_personagem.classe_id = tb_classe.id WHERE tb_classe.id = 3;
